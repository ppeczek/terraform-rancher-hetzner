module "provider" {
  ...
  hetzner_subdomain       = var.hetzner_subdomain
...
module "rancher" {
  ...
  connections        = flatten(module.provider.public_ips)
  instance_count     = var.hetzner_server_count
  ...
  subdomain          = var.hetzner_subdomain
